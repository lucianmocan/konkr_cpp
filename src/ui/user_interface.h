...
// ui.h
// 
// Declares the UserInterface class, which manages the user interface of the game.
// It includes the home page, level selection screen, and game screen.
// It handles user input and rendering of the UI elements.
//
...
class UserInterface {
    ...
    UserInterface(sf::RenderWindow& window)
        : window_(window), gui_(window), current_state_(UserInterfaceState::HomePage) {
